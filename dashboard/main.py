...
st.markdown("Visualisasi interaktif ini adalah hasil dari analisis https://colab.research.google.com/drive/1-DejHEAD1CzmVg7MSse-ZkQapdn4JZZS?usp=sharing")
...
with tab4:
    ...
    with col2:
        ...
        plot_bar_chart(
            df=mon_lowest, x='monetary', y='customer_id', subheader='Top 10 Pendapatan Paling Rendah bagi Perusahaan (monetary)',
